...
public:
	...
	inline __SCLStaticData<_T>* GetBeginPtr() { return m_lpBeginPtr; } //'m_lpBeginPtr' may be undeclared or unknown
	inline void SetBeginPtr(__SCLStaticData<_T>* p) { m_lpBeginPtr = p; } //'m_lpBeginPtr' may be undeclared or unknown
	...
	void	Link(BOOL blPushBack = TRUE,BOOL blForce = FALSE)
	{
		...
		if( _T::m_sCLBegin.m_lpCLBegin == NULL ) // Begin�� ���� �ƴϸ� �翬�� End�� ���� �ƴϴ�.
		{
		...
		{	
			if(blPushBack)	// �ǵڿ��� �ִ´�.
			{
				...
				pOldEnd->m_lpNext = this;	// ������ End�� ���� �߰��� ������Ʈ�� ��ũ ��Ų��.
				_T::m_sCLBegin.m_lpCLEnd = this;
			...
			else			// �Ǿտ��� �ִ´�.
			{
				...
				pOldBegin->m_lpPre = this;	// ������ End�� ���� �߰��� ������Ʈ�� ��ũ ��Ų��.
				_T::m_sCLBegin.m_lpCLBegin = this;
